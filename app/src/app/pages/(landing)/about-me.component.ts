  ...
  template: `
    <div class="flex w-full items-center justify-between gap-x-4 p-4 xl:justify-around">
      ...
      <div class="text-right leading-6">
        <h1 class="text-primary text-2xl font-semibold dark:text-neutral-100">Alexander Ciesielski</h1>
        <h2 class="text-sm text-zinc-500 dark:text-zinc-400">Software Engineer, Angular Expert</h2>
      </div>
    </div>
